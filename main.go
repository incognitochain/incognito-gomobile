...
func generateIncognitoContractAddress(_ js.Value, args []js.Value) interface{} {
	result, err := gomobile.GenerateContractAddress(args[0].String())
	if err != nil {
		return nil
	}
...
func sign0x(_ js.Value, args []js.Value) interface{} {
	result, err := gomobile.Sign0x(args[0].String())
	if err != nil {
		return nil
	}
...
func signKyber(_ js.Value, args []js.Value) interface{} {
	result, err := gomobile.SignKyber(args[0].String())
	if err != nil {
		return nil
	}
...
func main() {
	...
	js.Global().Set("generateIncognitoContractAddress", js.FuncOf(generateIncognitoContractAddress))
	js.Global().Set("sign0x", js.FuncOf(sign0x))
	js.Global().Set("signKyber", js.FuncOf(signKyber))
